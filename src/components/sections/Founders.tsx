    ...
    <Section tone="off-white" space="loose">
      <Container>
        ...
        <Grid gap="loose">
          ...
          <Reveal from="left" className="col-span-4 md:col-span-5 md:col-start-1">
          ...
          {/* Theis — wider crop, sits lower for asymmetry */}
          <Reveal from="right" className="col-span-4 md:col-span-5 md:col-start-8 md:mt-24">
            <EditorialPlaceholder
        ...
        <Reveal delay={0.15}>
          <p className="caption mt-20 max-w-[52ch] text-near-black/40 md:mt-28">
