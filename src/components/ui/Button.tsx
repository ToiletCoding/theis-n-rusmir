...
const base =
  "notation group inline-flex items-center justify-center gap-3 border px-8 py-4 transition-colors duration-300 ease-out cursor-pointer";

const variants: Record<Tone, Record<Variant, string>> = {
  dark: {
    solid:
      "border-near-black bg-near-black text-off-white hover:bg-transparent hover:text-near-black",
    outline:
      "border-near-black/35 text-near-black hover:border-near-black hover:bg-near-black hover:text-off-white",
  },
  light: {
    solid:
      "border-off-white bg-off-white text-near-black hover:bg-transparent hover:text-off-white",
    outline:
      "border-off-white/35 text-off-white hover:border-off-white hover:bg-off-white hover:text-near-black",
  },
};
